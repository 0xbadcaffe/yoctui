...
Press `x` to inspect the effective `BBMASK` patterns and their backend-provided provenance. This is intentionally read-only; future edits will preview the exact configuration change and require confirmation.
