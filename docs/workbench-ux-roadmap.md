...
| 1 | Action catalog, menus, keybindings, focus, scrolling | `UX-ACTION-CATALOG-001` through `UX-SCROLL-001` | 4/6 |
...
tasks makes overall required progress **547/578 (94.6%)**. The research/spec,
