...
| 3 | Dependency topology, rootfs composition, optional image preview | `UX-DEPENDENCY-GRAPH-001` through `UX-IMAGE-PREVIEW-001` | 3/5 |
...
| **M21 total** | | | **22/38 (57.9%)** |

The historical product registry was 540/540 before M21. Registering these 38
tasks makes overall required progress **562/578 (97.2%)**. The research/spec,
