...
| 1 | Action catalog, menus, keybindings, focus, scrolling | `UX-ACTION-CATALOG-001` through `UX-SCROLL-001` | 1/6 |
...
tasks makes overall required progress **544/578 (94.1%)**. The research/spec,
...
116-entry typed action catalog now drives global palette metadata/search,
