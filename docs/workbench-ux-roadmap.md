...
| 2 | Shared widgets, progress, telemetry, logs, editors, checkboxes, trees | `UX-WIDGET-PRIMITIVES-001` through `UX-LIST-TREE-001` | 4/10 |
...
| **M21 total** | | | **14/38 (36.8%)** |

The historical product registry was 540/540 before M21. Registering these 38
tasks makes overall required progress **554/578 (95.8%)**. The research/spec,
