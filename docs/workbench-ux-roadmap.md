...
| 4 | Terminal, dashboard, command center, onboarding, preferences | `UX-TERMINAL-EVAL-001` through `UX-PREFERENCES-001` | 4/6 |
...
| **M21 total** | | | **28/38 (73.7%)** |

The historical product registry was 540/540 before M21. Registering these 38
tasks makes overall required progress **568/578 (98.3%)**. The research/spec,
...
136-entry typed action catalog now drives global palette metadata/search,
