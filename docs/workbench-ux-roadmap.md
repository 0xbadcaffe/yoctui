...
| 5 | Responsive, accessibility, performance, PTY/live evidence, docs | `UX-RESPONSIVE-001` through `UX-DOC-001` | 1/7 |
| 6 | Parent completion gate | `UX-001` | 0/1 |
| **M21 total** | | | **31/38 (81.6%)** |

The historical product registry was 540/540 before M21. Registering these 38
tasks makes overall required progress **571/578 (98.8%)**. The research/spec,
