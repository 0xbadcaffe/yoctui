...
| 1 | Action catalog, menus, keybindings, focus, scrolling | `UX-ACTION-CATALOG-001` through `UX-SCROLL-001` | 3/6 |
...
tasks makes overall required progress **546/578 (94.5%)**. The research/spec,
