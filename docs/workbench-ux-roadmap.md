...
| 5 | Responsive, accessibility, performance, PTY/live evidence, docs | `UX-RESPONSIVE-001` through `UX-DOC-001` | 5/7 |
| 6 | Parent completion gate | `UX-001` | 0/1 |
| **M21 total** | | | **35/38 (92.1%)** |

The historical product registry was 540/540 before M21. Registering these 38
tasks makes overall required progress **575/578 (99.5%)**. The research/spec,
