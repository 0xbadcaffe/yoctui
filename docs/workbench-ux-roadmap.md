...
| 1 | Action catalog, menus, keybindings, focus, scrolling | `UX-ACTION-CATALOG-001` through `UX-SCROLL-001` | 2/6 |
...
tasks makes overall required progress **545/578 (94.3%)**. The research/spec,
