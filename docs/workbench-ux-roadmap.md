...
| 1 | Action catalog, menus, keybindings, focus, scrolling | `UX-ACTION-CATALOG-001` through `UX-SCROLL-001` | 5/6 |
...
tasks makes overall required progress **548/578 (94.8%)**. The research/spec,
...
122-entry typed action catalog now drives global palette metadata/search,
