...
| Operator documentation | IN_PROGRESS | Installation, guarded Yocto quickstarts, the daily operator/troubleshooting guide, and structured live-versus-fixture compatibility evidence pass; deterministic documentation validation remains |

## Priority queue

1. `DOC-VERIFY-001` — validate documentation links and safe commands deterministically
2. `DOC-001` — close the operator-documentation parent gate
