...
Discover kickstarts and execute Wic creation safely.
...
| Wic workflow | IN_PROGRESS | Pure typed creation/device state and lifecycle are complete; canonical Wic/kickstart discovery, bounded partition parsing, safe cooked-mode execution, and exact output scanning are active |
...
1. `WIC-ADAPTER-001` — discover kickstarts and execute Wic creation safely
