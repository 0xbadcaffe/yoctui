...
- [IN_PROGRESS] Configure coverage (`cargo llvm-cov`, `pytest-cov`) with thresholds. Model/protocol Rust thresholds are enforced: `9c2ca20`; bridge Python coverage is 81.36% and pending commit.
