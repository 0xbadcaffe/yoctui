...
- [IN_PROGRESS] Complete structured errors screen with selection/detail/log jump. Table/detail: `bec99cf`; selection: `4ed019b`; log jump: `8f0154f`; timestamp detail: `b14fcff`. Cross-screen context and richer parsing remain.
