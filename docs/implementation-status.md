...
- [IN_PROGRESS] Build the Yocto workbench: Devtool-backed in-TUI recipe editing with a two-pane workspace browser and save controls: `608b248`; read-only effective BBMASK inspection: `2e459fd`; dependency graph, metadata layer tree, editable BBMASK, and additional Devtool operations are planned in [yocto-workbench-plan.md](yocto-workbench-plan.md).
