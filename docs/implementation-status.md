...
- [IN_PROGRESS] Complete workspace fields, recipe/layer discovery, variable provenance, CLI subcommand outputs, editor configuration, session persistence, and all configuration settings. Environment-derived Yocto/OpenEmbedded release discovery: `0d693b9`; preferred editor configuration: `9ac79a6`; color configuration: `0c7e551`; cancellation timeout: `ad293af`; interactive session preferences and recent directories: `272c54c`; CLI variable provenance: `ee111c9`; server-backed recipe/layer data: `996a6d8`. Verification: fake bridge and CLI integration tests.
