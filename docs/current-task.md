...
Poky composition at the latest stable release selected from authoritative
Yocto release documentation.
...
- A fresh official Poky composition records exact release, component Git
  commits, and BitBake version evidence.
